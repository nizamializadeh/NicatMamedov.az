    ...
    @foreach($projects as $project)
        <tr>
            ...
            <td>
                ...
                <form action="{{route('portfolio.destroy',['blog' => $project->id])}}" method="post">
                    {{ method_field('delete') }}
                    @csrf
                    <a class="btn bg-blue btn-circle waves-effect waves-circle waves-float" href="{{route('portfolio.edit',['portfolio' => $project->id])}}"><i class="material-icons">edit</i></a>
