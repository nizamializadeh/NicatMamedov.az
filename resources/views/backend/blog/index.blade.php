    ...
    @foreach($projects as $project)
        <tr>
            ...
            <td>
                ...
                <form action="{{route('blog.destroy',['blog' => $project->id])}}" method="post">
                    {{ method_field('delete') }}
                    @csrf
                    <a class="btn bg-blue btn-circle waves-effect waves-circle waves-float" href="{{route('blog.edit',['blog' => $project->id])}}"><i class="material-icons">edit</i></a>
