        ...
        <div class="row clearfix">
            <div class="col-sm-12">
                <div class="form-group form-float">
                    <div class="form-line">
                        ...
                        <label for="postImage" style="cursor: pointer">
                            ...
                            <img width="150px;" class="img-responsive thumbnail post-img-preview" src="{{asset('photo/'.$about->image)}}">
                        </label>
                    </div>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-sm-12">
                    <div class="form-group form-float">
                        <div class="form-line">
                            <textarea name="description" id="tinymce" aria-hidden="true">{{$about->description}} </textarea>
